                ...
                <div className={`${modal} w-full max-w-lg`}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-4 mt-6">
                            <a href={`/documents/${selectedDoc.id}/download`} download className={`${pill} flex-1 justify-center`}>
                                ...
                                {filteredDocuments.map(doc => (
                                    <tr key={doc.id} className={trRow}>
                                        ...
                                        <td className="px-6 py-4 flex gap-2">
                                            <a href={`/documents/${doc.id}/download`} download className="p-2 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg transition-colors text-slate-600 dark:text-slate-400"><Download size={16} /></a>
